...
public class FoodColor extends Ingredient implements ActionListener {
	 ...
	 private final EasySound2 foodColorSound = new EasySound2("sploosh.wav");
	 

	 
	 public FoodColor(int x, int y, JComponent surface) {
		  foodColor = new ImageIcon("food_coloring.png").getImage();
